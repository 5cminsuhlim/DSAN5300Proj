...
The plot represents that there are 4 most significant features based on the Elbow method.

This result corresponds to the linear regression result, in which reveals that the 4 most significant features are as following:
...
The RMSE here is the square root of the within cluster sum of squares, which does not have explicit meaning but could be used as a reference of viewing the number of clusters from a different perspective.
